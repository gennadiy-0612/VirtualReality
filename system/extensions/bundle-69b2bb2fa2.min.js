...
/* stockholm.js */
console.log(navigator.language);if((navigator.language==='en')&&(location.href==='https://p.cx.ua/virtual/')){window.location.replace('https://p.cx.ua/virtual/en/')}
if((navigator.language==='ru')&&(location.href==='https://p.cx.ua/virtual/')){window.location.replace('https://p.cx.ua/virtual/ru/')}
if((navigator.language==='uk')&&(location.href==='https://p.cx.ua/virtual/')){window.location.replace('https://p.cx.ua/virtual/ru/')};
