    ...
    this.checkVision = function (init) {
        ...
        function vdHandler(els) {
            els.forEach((data) => {
                ...
                if (data.intersectionRatio>.6) data.target.setAttribute('style', 'filter:grayscale(0%);')
                if (data.intersectionRatio>.7) data.target.setAttribute('style', 'filter:grayscale(50%);')
