...
shch.LoadFunc = function () {
    ...
    shch['.RoundBox-1'] = new shch.manipulated('.RoundBox-1', 800, 2500, 'Rotate', '45','#e80055', 1, .9);
    ...
    shch['.RoundBox-7'] = new shch.manipulated('.RoundBox-7', 800, 2500, 'Rotate', '12', '#e80055', 1, .6);
